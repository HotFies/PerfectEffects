package org.aneras.mc.trails.other;
   ...
   /* @Override
    ...
    public void display(Location location, Player player)
    {
        ...
        for(Point3D point : outline)
        {
            ...
            playerWorld.spawnParticle(Particle.REDSTONE, new Location(playerWorld, rotated.x + x, rotated.y + y, rotated.z +z), 0, new Particle.DustOptions(Color.BLACK, 1));
            ...
            playerWorld.spawnParticle(Particle.REDSTONE, new Location(playerWorld, rotated.x + x, rotated.y + y, rotated.z +z), 5, new Particle.DustOptions(Color.BLACK, 1));
        }
        ...
        for(Point3D point : fill)
        {
            ...
            playerWorld.spawnParticle(Particle.SWEEP_ATTACK, new Location(playerWorld, rotated.x + x, rotated.y + y, rotated.z +z), 0);
